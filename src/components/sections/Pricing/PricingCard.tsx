  ...
  return (
    <motion.div
      className={cn(
        ...
        tier.highlighted
          ? 'bg-ixra-blue/5 border-ixra-blue/50'
    ...
    >
      ...
      {tier.highlighted && (
        <div className="absolute -top-3 left-1/2 -translate-x-1/2">
          <span className="px-3 py-1 text-xs font-medium text-void bg-ixra-blue rounded-full">
            Most Popular
          </span>
        </div>
      )}
      ...
      <p className={cn(
        ...
        tier.highlighted ? 'text-ixra-blue' : 'text-plasma-white'
      )}>
        {tier.priceRange}
      </p>
        ...
        {tier.features.map((feature, i) => (
          <li key={i} className="flex items-start gap-3">
            <Check className={cn(
              ...
              tier.highlighted ? 'text-ixra-blue' : 'text-success-green'
            )} />
